...
const formulaTemplates = [
  {
    ...
    description: "Generate a sheet with the most important formulas",
    prompt: "Create a formula sheet with essential equations and constants",
    icon: <Lightbulb className="h-5 w-5" />,
  },
  {
    name: "Exam Reference",
    description: "Generate a comprehensive formula reference for exams",
    prompt: "Create a comprehensive formula reference sheet for exam use",
...
export function FormulaGenerator() {
  ...
  // State for generated formula sheet
  const [formulaSheet, setFormulaSheet] = useState<string | null>(null)
  ...
  const handleBack = () => {
    window.dispatchEvent(new CustomEvent("cancel-formula-generator"))
  }
  ...
  const selectTemplate = (index: number) => {
    ...
    setCustomPrompt(formulaTemplates[index].prompt)
  }
  ...
  const handleGenerate = async () => {
    ...
    if (!customPrompt.trim()) {
      alert("Please enter a prompt for formula generation")
      return
    }
    ...
    try {
      ...
      // Call the API to generate formula sheet
      ...
      alert("Error generating formula sheet. Please try again.")
      setIsGenerating(false)
    }
  }
  ...
  // Handle back from formula sheet viewer
  const handleBackFromViewer = () => {
    setFormulaSheet(null)
  }

  // If formula sheet has been generated, show the formula sheet viewer
  if (formulaSheet) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-16 transition-colors duration-200">
        ...
        <div className="bg-gradient-to-r from-[#8a2432] to-[#b02a3a] dark:from-purple-900 dark:to-purple-800 text-white py-6 shadow-md mb-8 transition-colors duration-200">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
            ...
            <h1 className="text-3xl font-bold">Formula Sheet</h1>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-16 transition-colors duration-200">
      ...
      <div className="bg-gradient-to-r from-[#8a2432] to-[#b02a3a] dark:from-purple-900 dark:to-purple-800 text-white py-6 shadow-md mb-8 transition-colors duration-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          <h1 className="text-3xl font-bold">Generate Formula Sheet</h1>
        </div>
      </div>
              ...
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-300">
                    Select one or more topics to generate a formula sheet. The sheet will include essential equations
                    and constants for your selected topics.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 mb-8 transition-colors duration-200">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  placeholder="Describe what kind of formula sheet you want to generate..."
                  rows={3}
              ...
              <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <p>
                    ...
                    {selectedTemplate !== null ? formulaTemplates[selectedTemplate].name : "Custom"}
                  </p>
                  <p>
                    <span className="font-medium">Content type:</span> Formula sheet with equations and constants
                  </p>
                </div>
              </div>
                ...
                {isGenerating ? (
                  <div className="mb-4">
                    ...
                    <div className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      {generationProgress >= 20 && generationProgress < 40 && "Extracting key formulas..."}
                      {generationProgress >= 40 && generationProgress < 60 && "Organizing equations..."}
                      {generationProgress >= 60 && generationProgress < 80 && "Formatting formula sheet..."}
                      {generationProgress >= 80 && "Finalizing your formula sheet..."}
                    </div>
                  </div>
                ) : (
                  <Button
